...
import { EnvironmentOtlpHttpConfigurationProvider } from '../../../../../src/common/http/node/configuration/environment-provider';
...
describe('environment configuration provider', function () {
  describe('headers', function () {
    ...
    it('unset if env vars are not set', function () {
      ...
      const config = new EnvironmentOtlpHttpConfigurationProvider(
        'METRICS',
        'v1/metrics'
      ).provide();
