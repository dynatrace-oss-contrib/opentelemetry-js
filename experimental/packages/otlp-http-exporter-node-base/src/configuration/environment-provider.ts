 ...
 */
export class EnvironmentOtlpHttpConfigurationProvider
  implements IConfigurationProvider<Partial<OtlpHttpConfiguration>>
{
  /**
   *
   * @param _signalIdentifier all caps part in environment variables that identifies the signal (e.g.: METRICS, TRACES, LOGS)
   * @param _signalResourcePath signal resource path to append if necessary (e.g.: v1/metrics, v1/traces, v1/logs)
   */
  constructor(
