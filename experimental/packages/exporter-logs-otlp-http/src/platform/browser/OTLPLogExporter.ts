...
import { OTLPJsonExporterBrowserBase } from '@opentelemetry/otlp-exporter-base';
...
export class OTLPLogExporter
  extends OTLPJsonExporterBrowserBase<ReadableLogRecord, IExportLogsServiceRequest>
