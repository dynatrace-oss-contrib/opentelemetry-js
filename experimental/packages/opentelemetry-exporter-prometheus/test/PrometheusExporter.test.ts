...
describe('PrometheusExporter', () => {
  ...
  describe('export', () => {
    ...
    it('should export a count aggregation', done => {
      ...
      const boundCounter = counter.bind({ key1: 'attrValue1' });
      boundCounter.add(10);
      meter.collect().then(() => {
              ...
              .get('http://localhost:9464/metrics', res => {
                res.on('data', chunk => {
                  ...
                  assert.deepStrictEqual(lines, [
                    ...
                    `counter_total{key1="attrValue1"} 20 ${mockedHrTimeMs}`,
                    '',
                  ]);
    ...
    it('should export multiple attributes', done => {
      ...
      counter.bind({ counterKey1: 'attrValue1' }).add(10);
      counter.bind({ counterKey1: 'attrValue2' }).add(20);
      meter.collect().then(() => {
        exporter.export(meter.getProcessor().checkPointSet(), () => {
          http
            .get('http://localhost:9464/metrics', res => {
              res.on('data', chunk => {
                ...
                assert.deepStrictEqual(lines, [
                  '# HELP counter_total a test description',
                  '# TYPE counter_total counter',
                  `counter_total{counterKey1="attrValue1"} 10 ${mockedHrTimeMs}`,
                  `counter_total{counterKey1="attrValue2"} 20 ${mockedHrTimeMs}`,
                  '',
                ]);
    ...
    it('should export multiple attributes on manual shutdown', done => {
      ...
      counter.bind({ counterKey1: 'attrValue1' }).add(10);
      counter.bind({ counterKey1: 'attrValue2' }).add(20);
      counter.bind({ counterKey1: 'attrValue3' }).add(30);
          ...
          .get('http://localhost:9464/metrics', res => {
            res.on('data', chunk => {
              ...
              assert.deepStrictEqual(lines, [
                ...
                `counter_total{counterKey1="attrValue1"} 10 ${mockedHrTimeMs}`,
                `counter_total{counterKey1="attrValue2"} 20 ${mockedHrTimeMs}`,
                `counter_total{counterKey1="attrValue3"} 30 ${mockedHrTimeMs}`,
                '',
              ]);
            ...
            .get('http://localhost:9464/metrics', res => {
              res.on('data', chunk => {
                ...
                assert.deepStrictEqual(lines, [
                  ...
                  '# TYPE counter_total counter',
                  `counter_total{key1="attrValue1"} 10 ${mockedHrTimeMs}`,
                  '',
                ]);
            ...
            .get('http://localhost:9464/metrics', res => {
              res.on('data', chunk => {
                ...
                assert.deepStrictEqual(lines, [
                  ...
                  `counter_bad_name_total{key1="attrValue1"} 10 ${mockedHrTimeMs}`,
                  '',
                ]);
    ...
    it('should export a UpDownCounter as a gauge', done => {
      ...
      counter.bind({ key1: 'attrValue1' }).add(20);
      meter.collect().then(() => {
        exporter.export(meter.getProcessor().checkPointSet(), () => {
          http
            .get('http://localhost:9464/metrics', res => {
              res.on('data', chunk => {
                assert.deepStrictEqual(chunk.toString().split('\n'), [
                  ...
                  '# TYPE counter gauge',
                  `counter{key1="attrValue1"} 20 ${mockedHrTimeMs}`,
                  '',
                ]);
            ...
            .get('http://localhost:9464/metrics', res => {
              res.on('data', chunk => {
                ...
                assert.deepStrictEqual(lines, [
                  ...
                  `metric_observable_counter{key1="attrValue1"} 20 ${mockedHrTimeMs}`,
                  '',
                ]);
              });
            ...
            .get('http://localhost:9464/metrics', res => {
              res.on('data', chunk => {
                ...
                assert.deepStrictEqual(lines, [
                  ...
                  `metric_observable_up_down_counter{key1="attrValue1"} 20 ${mockedHrTimeMs}`,
                  '',
                ]);
              });
    ...
    it('should export a Histogram as a summary', done => {
      ...
      histogram.bind({ key1: 'attrValue1' }).record(20);
            ...
            .get('http://localhost:9464/metrics', res => {
              res.on('data', chunk => {
                ...
                assert.deepStrictEqual(lines, [
                  ...
                  `test_histogram_count{key1="attrValue1"} 1 ${mockedHrTimeMs}`,
                  `test_histogram_sum{key1="attrValue1"} 20 ${mockedHrTimeMs}`,
                  `test_histogram_bucket{key1="attrValue1",le="+Inf"} 1 ${mockedHrTimeMs}`,
                  '',
                ]);
  ...
  describe('configuration', () => {
    ...
    beforeEach(() => {
      ...
      counter.bind({ key1: 'attrValue1' }).add(10);
    });
              ...
              .get('http://localhost:9464/metrics', res => {
                res.on('data', chunk => {
                  ...
                  assert.deepStrictEqual(lines, [
                    ...
                    `test_prefix_counter_total{key1="attrValue1"} 10 ${mockedHrTimeMs}`,
                    '',
                  ]);
              ...
              .get('http://localhost:9464/metrics', res => {
                res.on('data', chunk => {
                  ...
                  assert.deepStrictEqual(lines, [
                    '# HELP counter_total description missing',
                    '# TYPE counter_total counter',
                    'counter_total{key1="attrValue1"} 10',
                    '',
                  ]);
